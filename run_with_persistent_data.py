...
parser.add_argument('init_config', default=None, nargs='?', help='The path to the configuration file which describes what the pipeline should do.')
parser.add_argument('repeat_config', default=None, nargs='?', help='The path to the configuration file which describes what the pipeline should do.')
...
if args.init_config is None:
    print(parser.format_help())
    exit(0)


if args.repeat_config is None:
    print(parser.format_help())
    exit(0)
...
if len(required_packages) > 0:
    ...
    print("\npython_bin_folder: ",python_bin_folder)
    print("\npre_python_package_path: ",pre_python_package_path)
...
path_src_run = os.path.join(repo_root_directory, "src/run_with_persistent_data.py")
